 ...
 *           from CMSIS SVD File 'XMC1100_Processed_SVD.xml' Version 1.0.3 (Reference Manual v1.0),
 *******************************************************************************************************/
...
typedef struct {                                    /*!< (@ 0xE000E000) PPB Structure                                          */
  ...
  __IO uint32_t  NVIC_ISER;                         /*!< (@ 0xE000E108) Interrupt Set-enable Register                          */
  __I  uint32_t  RESERVED2[31];
  __IO uint32_t  NVIC_ICER;                         /*!< (@ 0xE000E188) IInterrupt Clear-enable Register                       */
  __I  uint32_t  RESERVED3[31];
  __IO uint32_t  NVIC_ISPR;                         /*!< (@ 0xE000E208) Interrupt Set-pending Register                         */
  __I  uint32_t  RESERVED4[31];
  __IO uint32_t  NVIC_ICPR;                         /*!< (@ 0xE000E288) Interrupt Clear-pending Register                       */
  __I  uint32_t  RESERVED5[95];
  __IO uint32_t  NVIC_IPR0;                         /*!< (@ 0xE000E408) Interrupt Priority Register 0                          */
  __IO uint32_t  NVIC_IPR1;                         /*!< (@ 0xE000E40C) Interrupt Priority Register 1                          */
  __IO uint32_t  NVIC_IPR2;                         /*!< (@ 0xE000E410) Interrupt Priority Register 2                          */
  __IO uint32_t  NVIC_IPR3;                         /*!< (@ 0xE000E414) Interrupt Priority Register 3                          */
  __IO uint32_t  NVIC_IPR4;                         /*!< (@ 0xE000E418) Interrupt Priority Register 4                          */
  __IO uint32_t  NVIC_IPR5;                         /*!< (@ 0xE000E41C) Interrupt Priority Register 5                          */
  __IO uint32_t  NVIC_IPR6;                         /*!< (@ 0xE000E420) Interrupt Priority Register 6                          */
  __IO uint32_t  NVIC_IPR7;                         /*!< (@ 0xE000E424) Interrupt Priority Register 7                          */
  __I  uint32_t  RESERVED6[566];
...
typedef struct {                                    /*!< (@ 0x40010000) SCU_GENERAL Structure                                  */
  ...
  __IO uint32_t  IDCHIP;                            /*!< (@ 0x40010004) Chip ID Register                                       */
...
/**
  * @brief System Control Unit (SCU_CLOCK)
  */

typedef struct {                                    /*!< (@ 0x40010300) SCU_CLOCK Structure                                    */
...
/**
  * @brief System Control Unit (SCU_COMPARATOR)
  */

typedef struct {                                    /*!< (@ 0x40010500) SCU_COMPARATOR Structure                               */
...
typedef struct {                                    /*!< (@ 0x48030000) VADC Structure                                         */
  ...
  __IO uint32_t  GLOBICLASS0;                       /*!< (@ 0x480300A0) Input Class Register 0, Global                         */
  __IO uint32_t  GLOBICLASS1;                       /*!< (@ 0x480300A4) Input Class Register 1, Global                         */
...
/* ------------------------------  SCU_GENERAL_SRRAW  ----------------------------- */
#define SCU_GENERAL_SRRAW_PRWARN_Pos          0                                                       /*!< SCU_GENERAL SRRAW: PRWARN Position      */
#define SCU_GENERAL_SRRAW_PRWARN_Msk          (0x01UL << SCU_GENERAL_SRRAW_PRWARN_Pos)                /*!< SCU_GENERAL SRRAW: PRWARN Mask          */
#define SCU_GENERAL_SRRAW_PI_Pos              1                                                       /*!< SCU_GENERAL SRRAW: PI Position          */
#define SCU_GENERAL_SRRAW_PI_Msk              (0x01UL << SCU_GENERAL_SRRAW_PI_Pos)                    /*!< SCU_GENERAL SRRAW: PI Mask              */
